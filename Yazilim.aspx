<%@ Page Title="" Language="C#" MasterPageFile="~/MercanPage.master" AutoEventWireup="true" CodeFile="Yazilim.aspx.cs" Inherits="Yazilim" %>
...
<%
    ...
    {
        Response.Write("<li><a href='Yazilim.aspx?MercanYaziliM=" + Convert.ToInt32(_dtMenu.Rows[i]["idYazilim"]) + "'>" + _dtMenu.Rows[i]["YazilimAdi"].ToString() + "</li>");
    }
