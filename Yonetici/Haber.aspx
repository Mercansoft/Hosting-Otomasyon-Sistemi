<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetici/Admin.master" AutoEventWireup="true" CodeFile="Haber.aspx.cs" Inherits="Yonetici_Haber" %>
                            ...
                            <tr>
                                ...
                                <td style="width: 190px">
                                    <asp:Button ID="Button1" runat="server" Text="Düzenle" 
                                        onclick="Button1_Click" Height="27px" Width="55px" />
                                    &nbsp;<asp:Button ID="Button5" runat="server" Text="Kayit" 
                                        onclick="Button5_Click" Height="27px" Width="40px" />
